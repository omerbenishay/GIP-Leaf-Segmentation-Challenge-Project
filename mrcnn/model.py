...
from LeafSegmentorInfer import calculate_iou

from mrcnn import utils

from .ara_utils import ARA_ModelCheckpoint
...
#  Utility Functions
############################################################
def MetricIoU(y_test, y_pred):
    return calculate_iou("", y_pred, y_test, False)
...
class MaskRCNN():
    ...
    def load_weights(self, filepath, by_name=False, exclude=None):
        ...
        # AZ change - !!! DON"T Update the log directory
    ...
    def set_log_dir(self, model_path=None):
        ...
        self.checkpoint_path = os.path.join(self.log_dir, "mask_rcnn_{}.h5".format(self.config.NAME))
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        callbacks = [
            ...
            # keras.callbacks.ModelCheckpoint(os.path.join(self.log_dir, "bestModel.h5"),
...
def mold_image(images, config):
    ...
    #return images.astype(np.float32)[:,:,:3] - config.MEAN_PIXEL
