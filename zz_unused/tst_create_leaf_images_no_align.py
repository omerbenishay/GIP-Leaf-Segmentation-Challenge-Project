...
OUT_DIR_170 = 'C:/alon/agriculture/avocado/ann_170_leaves_U/'

TASK_ID_171 = 171
IMG_DIR_171 = 'C:/alon/Phenomics_tst_images_jsons/task_171/'
JSON_DIR_171 = 'C:/alon/Phenomics_tst_images_jsons/task_171/'
OUT_DIR_171 = 'C:/alon/agriculture/avocado/ann_171_leaves_U/'

TASK_ID_169 = 169
IMG_DIR_169 = 'C:/alon/Phenomics_tst_images_jsons/task_169/'
JSON_DIR_169 = 'C:/alon/Phenomics_tst_images_jsons/task_169/'
OUT_DIR_169 = 'C:/alon/agriculture/avocado/ann_169_leaves_U/'

TASK_ID_183 = 183
IMG_DIR_183 = 'C:/alon/Phenomics_tst_images_jsons/task_183/'
JSON_DIR_183 = 'C:/alon/Phenomics_tst_images_jsons/task_183/'
OUT_DIR_183 = 'C:/alon/agriculture/avocado/ann_183_leaves_U/'
...
OUT_DIR_AVOCADO_ABCD = 'C:/alon/agriculture/avocado/avocado_all_U/'
...
OUT_DIR_172 = 'C:/alon/agriculture/corn_ann_172/tst_leaves_aligned_S/'
...
def parse_json_task_171(json_data, task_ids):
    ...
    for i in range(num_data):
        ...
        if not(ann_type == 'polygon' or ann_type == 'point'):
            # discard this annotation if it is not listed as a point or polygon
            continue
    ...
    for i in range(num_data):
        ...
        polygons[i] = curr_vals
        new_element = {'polygon': polygons[i], 'leafID': (i + 1)}
...
def main():
    ...
    # task_ids = [183]
    # json_dir = JSON_DIR_183
    # img_dir = IMG_DIR_183
    # out_dir = OUT_DIR_183

    # task_ids = [151,169,170,171,184,185,186]
    # json_dir = JSON_DIR_169
    # img_dir = IMG_DIR_169
    # out_dir = OUT_DIR_169

    task_ids = [169,184,185,186]
